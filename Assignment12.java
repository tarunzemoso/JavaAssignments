...
public class Assignment12 {
    public static void main(String[] args){
        ...
        Map<String, Double> avgPercentOfDepartments= list.stream().collect(Collectors.groupingBy(Student::getDepartment, Collectors.averagingDouble(Student::getTillDate)));
        ...
        Optional<Student> youngestMaleStudentInElectronicWrapper= list.stream().filter(e -> e.getGender()=="Male" && e.getDepartment()=="Electronic").min(Comparator.comparingInt(Student::getAge));
        ...
        System.out.println("Year Of Joining : "+youngestMaleStudentInElectronic.getYearOfJoining());
